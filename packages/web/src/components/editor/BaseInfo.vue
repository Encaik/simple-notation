  ...
  >
    ...
    >
      <div class="flex flex-col gap-2 min-w-0">
        <label for="title-input" class="font-medium text-[#333] whitespace-nowrap">标题</label>
        <input
          type="text"
          id="title-input"
          :value="editorStore.formData.info.title"
          @input="updateInfo('title', ($event.target as HTMLInputElement).value)"
          placeholder="请输入标题..."
          class="p-2 px-3 border border-[#ddd] rounded text-sm bg-white bg-opacity-80"
        />
      </div>
      <div class="flex flex-col gap-2 min-w-0">
        <label for="composer-input" class="font-medium text-[#333] whitespace-nowrap">作曲</label>
        <input
          type="text"
          id="composer-input"
          :value="editorStore.formData.info.composer"
          @input="updateInfo('composer', ($event.target as HTMLInputElement).value)"
          placeholder="请输入作曲..."
          class="p-2 px-3 border border-[#ddd] rounded text-sm bg-white bg-opacity-80"
        />
      </div>
      <div class="flex flex-col gap-2 min-w-0">
        <label for="lyricist-input" class="font-medium text-[#333] whitespace-nowrap">作词</label>
        <input
          type="text"
          id="lyricist-input"
          :value="editorStore.formData.info.lyricist"
          @input="updateInfo('lyricist', ($event.target as HTMLInputElement).value)"
          placeholder="请输入作词..."
          class="p-2 px-3 border border-[#ddd] rounded text-sm bg-white bg-opacity-80"
        />
      </div>
      <div class="flex flex-col gap-2 min-w-0">
        <label for="author-input" class="font-medium text-[#333] whitespace-nowrap">作谱</label>
        <input
          type="text"
          id="author-input"
          :value="editorStore.formData.info.author"
          @input="updateInfo('author', ($event.target as HTMLInputElement).value)"
          placeholder="请输入作谱..."
          class="p-2 px-3 border border-[#ddd] rounded text-sm bg-white bg-opacity-80"
        />
      </div>
      <div class="flex flex-col gap-2 min-w-0">
        <label for="beat-input" class="font-medium text-[#333] whitespace-nowrap">拍数</label>
        <input
          type="text"
          id="beat-input"
      ...
      <div class="flex flex-col gap-2 min-w-0">
        <label for="time-input" class="font-medium text-[#333] whitespace-nowrap">拍号</label>
        <input
          type="text"
          id="time-input"
      ...
      <div class="flex flex-col gap-2 min-w-0">
        <label for="tempo-input" class="font-medium text-[#333] whitespace-nowrap">速度</label>
        <input
          type="text"
          id="tempo-input"
          :value="editorStore.formData.info.tempo"
          @input="updateInfo('tempo', ($event.target as HTMLInputElement).value)"
          placeholder="请输入速度..."
          class="p-2 px-3 border border-[#ddd] rounded text-sm bg-white bg-opacity-80"
        />
      </div>
      <div class="flex flex-col gap-2 min-w-0">
        <label for="key-input" class="font-medium text-[#333] whitespace-nowrap">调号</label>
        <select
          id="key-input"
...
import { type SNTemplateKey, type SNAbcKey } from 'simple-notation';
...
function updateInfo(key: keyof typeof editorStore.formData.info, value: string) {
